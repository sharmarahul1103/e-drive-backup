...
public class Config {
	...
	UserDetailsService userDetailsService()
	{
		...
		UserInfo userInfo=UserInfo.builder().id(1).username("rahul").password(passwordEncoder().encode("1234")).role(Roles.ROLE_ADMIN).build();
...
//				.roles("ADMIN")
//				.build();
//		System.out.println("Userdetails created-----"+user.getUsername()+"--"+user.getPassword()+"--"+user.getAuthorities());
